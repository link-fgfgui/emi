...
public class PluginCallerMixin {
	@Unique
	private static final Set<ResourceLocation> SKIPPED = Sets.newHashSet(
	...
	@Redirect(at = @At(value = "INVOKE", target = "Ljava/util/function/Consumer;accept(Ljava/lang/Object;)V"),
