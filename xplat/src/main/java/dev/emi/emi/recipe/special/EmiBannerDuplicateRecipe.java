...
public class EmiBannerDuplicateRecipe extends EmiPatternCraftingRecipe {
	...
	public static final List<BlockItem> BANNERS = List.of(
	...
	private final BlockItem banner;

	public EmiBannerDuplicateRecipe(BlockItem banner, ResourceLocation id) {
		super(List.of(
				EmiStack.of(banner),
	...
	public EmiStack getPattern(Random random, boolean reminder) {
		...
		BannerPatternLayers pattern = BannerPatternLayers.DEFAULT;
